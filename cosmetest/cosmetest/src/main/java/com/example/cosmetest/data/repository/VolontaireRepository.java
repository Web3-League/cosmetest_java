...
public interface VolontaireRepository extends JpaRepository<Volontaire, Integer> {
    ...
    @Query(value = "SELECT * FROM volontaire WHERE " +
            ...
            "CAST(tel_domicile_vol AS TEXT) LIKE :keyword OR " +
            "CAST(tel_portable_vol AS TEXT) LIKE :keyword OR " +
    ...
    @Query(value = "SELECT * FROM volontaire v WHERE " +
            ...
            "CAST(v.tel_domicile_vol AS TEXT) LIKE CONCAT('%', :searchText, '%') OR " +
            "CAST(v.tel_portable_vol AS TEXT) LIKE CONCAT('%', :searchText, '%'))",
            nativeQuery = true)
